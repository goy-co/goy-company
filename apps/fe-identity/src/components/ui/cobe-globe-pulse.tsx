...
const defaultMarkers: PulseMarker[] = [
  ...
  { id: "pulse-5", location: [47.37, 8.54], delay: 0.8 },
  { id: "pulse-6", location: [-23.55, -46.63], delay: 1.2 },
  { id: "pulse-7", location: [25.20, 55.27], delay: 0.3 },
]
  ...
  useEffect(() => {
    ...
    function init() {
      ...
      globe = createGlobe(canvas, {
        ...
        markerColor: [0.13, 0.77, 0.37], // Green-500
      ...
      {markers.map((m) => (
        ...
        >
          <span style={{
            ...
            border: "2px solid #22c55e", borderRadius: "50%", opacity: 0,
          ...
          <span style={{
            ...
            boxShadow: "0 0 0 3px #09090b, 0 0 0 5px #22c55e",
          }} />
        </div>
      ))}
    </div>
